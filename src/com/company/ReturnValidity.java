...
public class ReturnValidity {
    ...
    private UserData issuedBooksData = new UserData(".\\src\\com\\company\\issuedBooks.txt");
    ...
    public void decQuantityIncBooksRemoveIssued(){
        ...
        String todayDate;
        do{
            todayDate=JOptionPane.showInputDialog(null,"Enter Today Date :D");
        }while(!CheckDate.isValidDate(todayDate));
